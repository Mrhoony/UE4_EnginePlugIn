...
AGameCharacter::AGameCharacter()
{
	...
	if (asset.Succeeded())
	{
		...
		//UE_LOG(LogTemp, Error, TEXT("StaticMesh : %s"), *FString::SanitizeFloat(asset.Object->StaitMesh->GetName()));
		//UE_LOG(LogTemp, Error, TEXT("StaticMesh : %s"), *FString::SanitizeFloat(asset.Object->Material->GetName()));
	}
}
